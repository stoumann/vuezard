...
<style>
	.vue-wizard {
		...
		font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; /* TODO: REMOVE THIS */
	}

	.vue-wizard .wizard-header {
		display: flex;
		align-items: baseline;
	}

	.vue-wizard .wizard-header .wizard-title {
		font-size: 24px;
		margin: 0 10px 0 0;
		padding: 0;
	}

	.vue-wizard .wizard-header .wizard-subtitle {
		font-size: 14px;
		color: #999;
	}

	.vue-wizard .wizard-container {
		display: flex;
		align-items: stretch;
		height: 100%;
	}

	.vue-wizard .wizard-container .wizard-tabs .wizard-tablist { 
		list-style: none;
		margin: 0;
		padding: 0;
		height: 100%;
	...
	.vue-wizard .wizard-container .wizard-tabs .wizard-tablist li a {
		display: block;
		border-bottom: 1px solid #EDF2F7;
		text-decoration: none;
	}

	.vue-wizard .wizard-container .wizard-tabs .wizard-tablist li a.disabled {
		color: #999;
		cursor: not-allowed;
	}

	.vue-wizard .wizard-container .wizard-tabs .wizard-tablist li:last-child a {
		border-bottom: 0;
	}

	.vue-wizard .wizard-container .wizard-tabs .wizard-tablist .wizard-tab {
		margin: 0;
		padding: 10px;
	}

	.vue-wizard .wizard-container .wizard-content-footer {
		flex: 1;
		display: flex;
		flex-direction: column;
	}

	.vue-wizard .wizard-container .wizard-content-footer .wizard-content {
		margin: 0;
		padding: 10px;
		display: flex;
		flex: 1;
	...
	.vue-wizard .wizard-container .wizard-content-footer .wizard-card-footer {
		padding: 10px;
		background: #F7FAFC;
	...
	.vue-wizard .wizard-container .wizard-content-footer .wizard-card-footer .wizard-footer-right button {
		background: #2D3748;
		border: none;
		color: #ffffff;
		padding: 4px 12px;
	...
	.vue-wizard .wizard-container .wizard-content-footer .wizard-card-footer .wizard-footer-right button.finish-button {
